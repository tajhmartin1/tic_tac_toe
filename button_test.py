...
def bot():
    if game_over.get() == False:
        random.choice(unclicked_buttons).invoke()

'''Chooses a random button and clicks it but only when the game is not over.'''
...
'''when you press the two player button this function opens up a second multiplayer file''' 
...
btn1 = Button(root, text=" ", width=6,height=3,font=('Comic Sans MS','20'),command=lambda: clicked(buttons[0]))
btn1.grid(column=9, row=7)
btn2 = Button(root, text=" ", width=6,height=3,font=('Comic Sans MS','20'),command=lambda: clicked(buttons[1]))
btn2.grid(column=10, row=7)
btn3 = Button(root, text=" ", width=6,height=3,font=('Comic Sans MS','20'),command=lambda: clicked(buttons[2]))
btn3.grid(column=11, row=7)
btn4 = Button(root, text=" ", width=6,height=3,font=('Comic Sans MS','20'),command=lambda: clicked(buttons[3]))
btn4.grid(column=9, row=8)
btn5 = Button(root, text=" ", width=6,height=3,font=('Comic Sans MS','20'),command=lambda: clicked(buttons[4]))
btn5.grid(column=10, row=8)
btn6 = Button(root, text=" ", width=6,height=3,font=('Comic Sans MS','20'),command=lambda: clicked(buttons[5]))
btn6.grid(column=11, row=8)
btn7 = Button(root, text=" ", width=6,height=3,font=('Comic Sans MS','20'),command=lambda: clicked(buttons[6]))
btn7.grid(column=9, row=9)
btn8 = Button(root, text=" ", width=6,height=3,font=('Comic Sans MS','20'),command=lambda: clicked(buttons[7]))
btn8.grid(column=10, row=9)
btn9 = Button(root, text=" ", width=6,height=3,font=('Comic Sans MS','20'),command=lambda: clicked(buttons[8]))
btn9.grid(column=11, row=9)

play_button = Button(root, command=player_mode, text='two player')
play_button.grid(column=10, row=19)
...
'''creates rows, columns, and diagonals of buttons that are need to win'''
